...
(fact (set (map :move (queen-squares starting-board [3 3]))) =>
...
(fact (set (map :move (bishop-squares starting-board [3 3]))) =>
              #{[2 2] [1 1] [2 4] [1 5] [4 2] [5 1] [6 0] [4 4] [5 5] [6 6]})

(fact (set (map :move (rook-squares starting-board [3 3]))) =>
           #{[2 3] [1 3] [3 2] [3 1] [3 0] [3 4] [3 5]
             [3 6] [3 7] [3 8] [4 3] [5 3] [6 3]})

(rook-squares starting-board [7 0])

(fact (set (map :move (knight-squares [2 2]))) =>
           #{[0 1]
             [0 3]
             [1 0]
             [1 4]
